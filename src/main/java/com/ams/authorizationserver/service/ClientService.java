...
import com.ams.authorizationserver.dto.CreateClientDto;
import com.ams.authorizationserver.dto.MessageDto;
import com.ams.authorizationserver.entity.Client;
import com.ams.authorizationserver.repository.ClientRepository;
...
public class ClientService implements RegisteredClientRepository {
	...
	private Client clientFromDto(CreateClientDto dto) {
		Client client = Client.builder().clientId(dto.getClientId())
				.clientSecret(passwordEncoder.encode(dto.getClientSecret())) //Importate
				...
				.scopes(dto.getScopes()).requireProofKey(dto.isRequireProofKey()).build();
		return client;
	}
